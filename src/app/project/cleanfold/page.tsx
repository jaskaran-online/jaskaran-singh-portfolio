...
const content = [
  {
    ...
    content: <Image src="/CleanFold/Login.png" alt="alt" width={900} height={500} />,
  },
  {
    title: 'Dashboard',
    description:
    ...
    content: <Image src="/CleanFold/Dashboard.png" alt="alt" width={900} height={500} />,
  },
  {
    title: 'Cart',
    description:
    ...
    content: <Image src="/CleanFold/Cart.png" alt="alt" width={900} height={500} />,
  },
  {
    title: 'Rate List',
    description:
    ...
    content: <Image src="/CleanFold/RateListOfItems.png" alt="alt" width={900} height={500} />,
  },
  {
    title: 'Order Details',
    description:
    ...
    content: <Image src="/CleanFold/OrderDetails.png" alt="alt" width={900} height={500} />,
  },
  {
    ...
    content: <Image src="/CleanFold/OrderDetailItems.png" alt="alt" width={900} height={500} />,
  },
  {
    ...
    content: <Image src="/CleanFold/ListOfOrderDetails.png" alt="alt" width={900} height={500} />,
  },

  {
    ...
    content: <Image src="/CleanFold/CreateOrder.png" alt="alt" width={900} height={500} />,
  },
  {
    ...
    content: <Image src="/CleanFold/CategoryServices.png" alt="alt" width={900} height={500} />,
  },
];
    ...
    <Container>
      <div className="flex flex-col gap-8 pb-[20px]">
        <div className="flex flex-col gap-4">
          <h1 className="bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-center text-6xl font-bold text-transparent">
            CleanFold - Laundry Management Mobile App
          </h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-600 dark:text-gray-100">
            Our application is built using a modern tech stack that ensures high performance,
            scalability, and a seamless user experience. Below are the key technologies utilized in
            the development of the CleanFold app:
          </p>
          <div className="mb-12 mt-4 flex flex-wrap gap-6">
            <div className="flex items-center gap-6">
              <Image src={ReactNativeLogo} alt="React Native Logo" width={80} height={24} />
              <span className="font-semibold">React Native</span>
              <p className="text-sm text-gray-500 dark:text-gray-100">
                A powerful framework for building native mobile applications using React. It allows
                for a smooth user interface and performance comparable to native apps.
              </p>
            </div>
            <div className="flex items-center gap-12">
              ...
              />
              <p className="text-sm text-gray-500 dark:text-gray-100">
                A framework and platform for universal React applications. Expo simplifies the
                development process by providing a set of tools and services for building,
                deploying, and iterating on mobile apps.
              </p>
            </div>
            <div className="flex items-center gap-8">
              <Image src={LogoLaravel} alt="Laravel Logo" width={80} height={24} />
              <span className="font-semibold">Laravel</span>
              <p className="text-sm text-gray-500 dark:text-gray-100">
                A robust PHP framework that provides an elegant syntax and powerful tools for
                building web applications. Laravel is used for the backend services of the CleanFold
                app, ensuring secure and efficient data handling.
              </p>
            </div>
          </div>
        </div>

        <h1 className="mb-8 mt-4 bg-gradient-to-r from-blue-500 to-cyan-500  bg-clip-text text-center text-6xl font-bold text-transparent">
          Mobile App Screens
        </h1>
        <CleanFoldContent />
      </div>
