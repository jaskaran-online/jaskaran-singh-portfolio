    ...
    <nav className="sticky top-0 z-50 backdrop-filter backdrop-blur-lg border-b border-transparent">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <span className="text-2xl text-white font-semibold">JS</span>
...
function TwitterCard() {
  return (
    <div className="shadow-cyan-900/30 shadow-sm rounded-lg bg-slate-950/90 backdrop-filter backdrop-blur-3xl absolute lg:top-[53%] lg:-right-20 animate-float">
    ...
    <>
      ...
      <main>
                  ...
                  <header>
                    ...
                    <h1 className="heading-hero">
                      ...
                      <strong className="inline-grid">
                        ...
                        <strong className="relative col-start-1 row-start-1 bg-clip-text text-transparent">
                          Fullstack developer
                        </strong>
                      </strong>
                      .
        ...
        <section className="pt-10 pb-12 relative">
          <div className="mx-auto px-2 md:px-5 lg:px-8 2xl:max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-10 items-start">
              <div className="relative bottom-36 left-0 flex justify-center w-full">
                <HeroAnimation />
              </div>
              <div>
                <h1 className="font-title text-center text-[clamp(1rem,4vw,2.5rem)] font-black leading-[1.1]">
