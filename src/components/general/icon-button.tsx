...
const iconButtonVariants = cva(
  'flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 rounded-lg p-1.5 transition-colors duration-200 [&_svg]:stroke-gray-600 hover:[&_svg]:stroke-gray-700',
  {
    variants: {
      size: {
