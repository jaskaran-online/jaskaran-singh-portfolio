  ...
  return (
    <code className="code-one-dark">
      ...
      <div className="pl-4">
        ...
        <span className="text-purple-500 dark:text-[#98c379]">
          "Jaskaran Singh"
        </span>
        ,
      </div>
      <div className="pl-4">
        ...
        <span className="text-[#e06c75]">[</span>{" "}
        <span className="text-purple-500 dark:text-[#98c379]">"ReactJS"</span>,{" "}
        , <span className="text-purple-500 dark:text-[#98c379]">"PHP"</span>,{" "}
        <span className="text-purple-500 dark:text-[#98c379]">"NextJS"</span>,{" "}
        <span className="text-purple-500 dark:text-[#98c379]">
          "ReactNative"
        </span>{" "}
        ,<span className="text-purple-500 dark:text-[#98c379]">"Laravel"</span>
        <span className="text-[#e06c75]">]</span>,
      </div>
      <div className="pl-4">
        ...
        <div className="px-8 py-2">
          <header className="mb-2 flex items-center justify-between border-b border-b-gray-800 py-2 pb-3">
            ...
            <div className="flex justify-end">
              <button
                className="hf:text-white h-5 w-5 transition-colors dark:text-gray-400"
                type="button"
              >
    ...
    <ul className="sm:scrollbar-none fon t-medium mt-2 flex flex-wrap items-center justify-start gap-3 overflow-x-auto px-4 pb-2 text-[15px] ">
      ...
      <Link href={"https://nextjs.org/"} target="_blank">
        <li className="d:text-gray-400 flex items-center gap-2 text-gray-200">
          ...
          <span className="text-[#000000] dark:text-[#ffffff]">Next.js</span>
        </li>
      </Link>
      <Link href={"https://tailwindcss.com/"} target="_blank">
        <li className="d:text-gray-400 flex items-center gap-2 text-gray-200">
          ...
          <span className="text-[#000000] dark:text-[#ffffff]">Tailwind</span>
        </li>
      </Link>
      <Link href={"https://laravel.com/"} target="_blank">
        <li className="d:text-gray-400 flex items-center gap-2 text-gray-200">
          ...
          <span className="text-[#000000] dark:text-[#ffffff]">Laravel</span>
        </li>
      </Link>
    </ul>
  );
