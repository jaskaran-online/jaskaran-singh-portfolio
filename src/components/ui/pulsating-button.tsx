...
const PulsatingButton = ({
  ...
  return (
    ...
    >
      ...
      <span className="from-primary-600/0 via-primary-600/10 to-primary-600/0 absolute inset-0 bg-linear-to-r opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
